...
<table height="710" border="0" background="<?php echo base_url()?>images/mapa_nuevo3.jpg" style="width:2250px;">
<tr>
<?php
	...
	for($i=1;$i<=96;$i++){
		...
		if($punto1==$i){
			...
			for($j=1;$j<=$n;$j++){
				if($punto[$j]==1){
					?>
					<a href="<?php echo base_url()?>index.php/datos/control_form/<?php echo $disponible[$j]?>"><b><font color='#fff'><span background="#0C0" style="background-color:green;"><?php echo $disponible[$j]?></span></font></b></a>
					<?php
				}
			}
		...
		if(($punto1!=$i)and($punto2!=$i)and($punto3!=$i)){
			...
			for($y=1;$y<=$z;$y++){
				...
				$ban_ocu="si";
					?>
					<a href="<?php echo base_url()?>index.php/datos/control_form/<?php echo $ocupado[$y]?>"><b><font color='#fff'><span background="#0C0" style="background-color:red;"><?php echo $ocupado[$y]?></span></font></b></a>
					<?php
				}
			}
			$ban_des="no";
			for($x=1;$x<=$h;$x++){
				...
				if($destino2[$x]==$comp1){
					$ban_des="si";
					?>
					<a href="<?php echo base_url()?>index.php/datos/control_form/<?php echo $desocupado[$x]?>"><b><font color='#fff'><span background="#0C0" style="background-color:blue;"><?php echo $desocupado[$x]?></span></font></b></a>
					<?php
				}
			}
