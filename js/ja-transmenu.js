...
function TransMenu(oActuator, iDirection, iLeft, iTop, iReferencePoint, parentMenuSet) {
        ...
        function toString() {
                ...
                return '<div id="' + id + '" class="' + sClassName + '">' + 
                        ...
                        '<tr><td colspan="2"><img src="../index_files/%27%20+%20TransMenu.spacerGif%20+%20%27" width="1" height="' + TransMenu.menuPadding + '"></td></tr>' + 
                        aHtml.join('') + 
                        '<tr><td colspan="2"><img src="../index_files/%27%20+%20TransMenu.spacerGif%20+%20%27" width="1" height="' + TransMenu.menuPadding + '"></td></tr></table>' + 
                        '<div class="shadowBottom"><img src="../index_files/%27%20+%20TransMenu.spacerGif%20+%20%27" width="1" height="1"></div>' + 
                        '<div class="shadowRight"><img src="../index_files/%27%20+%20TransMenu.spacerGif%20+%20%27" width="1" height="1"></div>' + 
		        '<div class="background"><img src="../index_files/%27%20+%20TransMenu.spacerGif%20+%20%27" width="1" height="1"></div>' + 
	                '</div></div>';
        }
}
...
function TransMenuItem(sText, sUrl, oParent, browserNav, active) {
        ...
        function toString(bDingbat) {
				...
				var id = active?' id="active" ':'';
					/*return '<tr class="item"'+id+'><td nowrap style="' + sPaddingLeft + sPaddingRight + '"><div style="background: url(../index_files/%20+%20sDingbat%20+%20) right no-repeat;">' + 
                        sText + '</div></td></tr>';*/
                return '<tr class="item"'+id+'><td nowrap style="' + sPaddingLeft + '">' + 
                        sText + '</td><td width="10" style="' + sPaddingRight + '">' + 
                        '<img src="../index_files/%27%20+%20sDingbat%20+%20%27" width="8" height="8"></td></tr>';
        }
}
